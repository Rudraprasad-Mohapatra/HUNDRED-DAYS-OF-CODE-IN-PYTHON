...
# f=open('myfile.txt','b')#If no mode is mentioned then it is read mode 'r'
# print(f)
# text=f.read()
# print(text)
# f.close()
...
# Writing in a file
# z = open('myfile2.txt', 'w')
# # This will clear all the previous written things in file and replace it by (Hii, I am Raja).
# z.write("Hii, I am Raja ,learning python from cwh.")
# z.close()
# z = open('myfile2.txt', 'rt')
# text = z.read()
# print(text)
# z.close()

#Appending in a file
# z = open('myfile2.txt','a')#only change the mode from 'w' to 'a'.
# z.write("Ok I am appended,Hii RajaRudra!")
# z = open('myfile2.txt', 'rt')
# text = z.read()
# print(text)
# z.close()

# Shortcut to write the above format i.e. don't require of close() ,it closes automatically
...
f=open('myfile.txt','rb') #for reading binary files
