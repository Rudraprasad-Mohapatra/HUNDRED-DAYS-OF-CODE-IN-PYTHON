"""
x=[1,2,3]
print(dir(x)) #you will know all the methods of list
print(x.__add__)
y=(1,2,3)
print(dir(y)) #you will know all the methods of tuple
print(y.__add__)
...
p=Person("Harry",32)
print(p.__dict__) #output will be {'name': 'Harry', 'age': 32, 'version': 1} 
print(help(Person))
