...
# os.mkdir("data")  # it will create a folder named data
if (not os.path.exists("data")):
    os.mkdir("data")  # it will create a folder named data if data folder does not exist previously

for i in range(0, 100):
    os.mkdir(f"data/Day-{i+1}")
    # os.mkdir()

# Go to renam.py file to learn about how to rename the multiple folders at once
"""
os Module in Python
