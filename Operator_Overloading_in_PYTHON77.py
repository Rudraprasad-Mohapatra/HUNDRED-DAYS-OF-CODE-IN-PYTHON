...
# Use the above link to understand Python-Magic or Dunder Methods like __add__,__str__ etc.We will override these builtin magic methods which is known as operator overloading.
class Vector:
    ...
    def __add__(self,obj2): #overrides the addition operation for this class
        # return f"{self.i + obj2.i}i + {self.j + obj2.j}j + {self.k + obj2.k}k" # returns a string
