...
o.show_details()
# Printing the mro(Method Resolution Order) of GoldenRetriever
print(GoldenRetriever.mro()) 
# o/p is :- [<class '__main__.GoldenRetriever'>, <class '__main__.Dog'>, <class '__main__.Animal'>, <class 'object'>]
