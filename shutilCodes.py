import shutil
shutil.copy("Shutil_Module_in_PYTHON87.py","shutilCode.py")
shutil.copy2("Shutil_Module_in_PYTHON87.py","shutilCodes.py")
# shutil.copytree("pdf_Merger_folder","pdf_Merger_folder_mini_project")
# shutil.move("./pdf_Merger_folder_mini_project/Exercise_8_solution.py","Exercise_8_solution.py")
# shutil.rmtree("pdf_Merger_folder_mini_project")
