...
class Derived3(Derived1,Derived2): #multiple inheritance made form more than one parent
    pass

# Hierarchical Inheritance = Multiple inheitance + Multilevel inheitance
