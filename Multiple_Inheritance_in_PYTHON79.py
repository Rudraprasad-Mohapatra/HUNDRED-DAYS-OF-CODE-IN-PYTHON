...
print(o.name)
print(o.dance)
o.show() # Here in both parent class we have show() but we have mentioned Employee class first in DancerEmployee class so for the object of DancerEmployee class Employee class's show() will be called

# print(DancerEmployee.mro()) #[<class '__main__.DancerEmployee'>,<class '__main__.Dancer'>, <class '__main__.Employee'>,<class 'object'>]
# mro() will show where the methods will be searched in .Like when we call o.show() it first search in DancerEmployee class then search in firstmentioned Dancer class and then search in second mentioned Employee class.DancerEmployee(Dancer,Employee) 
