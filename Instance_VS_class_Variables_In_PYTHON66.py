class Employee:
    ...
    def showdetails(self):
        print(f"The name of the employee is {self.name} and the raise amount {self.companyName} in {self.noOfEmployees} sized company is {self.raise_amount} .") 
